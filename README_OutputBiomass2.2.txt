...
Origin Date:		02 Apr 2017
Final Date:		02 Apr 2017


Welcome to the source code repository for Extension-Output-Biomass, a LANDIS-II extension. 
Extension-Output-Biomass is an Output Extension that produces two types of maps:
	(1) Aboveground live biomass for individual species, (in g m⁻2)
	(2) Total aboveground live biomass for all species, (in g m⁻2)
